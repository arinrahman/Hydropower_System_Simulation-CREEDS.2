...
# Save Keras model predictions so we can load them later
np.save('keras_lstm_preds.npy', lstm_predictions)
np.save('keras_rnn_preds.npy', rnn_predictions)
np.save('keras_bidir_preds.npy', bidirectional_rnn_predictions)
np.save('keras_dense_preds.npy', dense_predictions)
np.save('y_test_keras.npy', y_test)
